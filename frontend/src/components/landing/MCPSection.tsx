          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="/nexo-mcp.zip"
                download
                className="inline-block px-6 py-3 bg-white text-black rounded-full font-bold hover:bg-gray-200 transition-all text-center"
              >
                ⬇ Descargar MCP Sandbox
              </a>
              <Link
                href="/mcp-setup"
                className="inline-block px-6 py-3 bg-transparent border border-white/30 text-white rounded-full font-bold hover:bg-white/10 transition-all text-center"
              >
