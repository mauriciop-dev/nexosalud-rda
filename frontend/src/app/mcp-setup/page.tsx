    ...
    <div className="min-h-screen bg-[#0d0f12] text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <a
          href="/nexo-mcp.zip"
          download
          className="inline-block mb-8 px-6 py-3 bg-white text-black rounded-full font-bold hover:bg-gray-200 transition-all"
        >
          ⬇ Descargar MCP Sandbox (zip)
        </a>
        <p className="text-sm text-gray-500 mb-8">
          El zip incluye <code className="text-green-400">index.js</code>, <code className="text-green-400">package.json</code> y un README con la configuración lista para Cursor, Claude Desktop y Cline. Ya viene conectado al sandbox público — no necesitas llaves.
        </p>
